...
<head>
	...
	<!-- Title -->
	<title>Wu Hsing Chuan Argentina - Hung Gar</title>
	<base href="../../">
	<!--[if lt IE 9]>
		<script>
					...
					<div class="filiales-flex">
						...
						<div class="filial">
							...
							<div class="group1">
								...
								<p class="filial__horario">Lunes, Miércoles y Viernes 21:00 a 22:30</p>
							</div>
							<div class="group2">
								<p class="filial__direccion">Calle 6 N° 1210</p>
								<br>
				...
				<article class="filiales-capital">
					...
					<div class="filiales-flex">
						...
						<div class="filial">
							...
							<div class="group1">
								<h3 class="filial__sifu">Sifu Hernán Dell'Oso</h3>
								<p class="filial__horario">Martes y Jueves de 19:00 a 21:00</p>
							</div>
							<div class="group2">
